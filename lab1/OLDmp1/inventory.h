...
struct inventory 
{
    int allocated_slots[MAXITEMS]; // Integer array that will be used to check which slots have been allocaed with memory 
    int first_item; // Used in inventory_first to see which item was first allocted in array and stores location in it
